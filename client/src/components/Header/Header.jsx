  ...
  return (
    <div className={styles.container}>
      ...
      {!isLoggedIn ?
        ...
        <div className={styles.loginGroup}>
          <button className={styles.loginButton}> <img className={styles.loginIcon} src={loginIcon} height={50} width={70} /><p>{`Welcome ${username}`}</p></button>
        </div>}

      <img className={styles.cartImage} src={cartImage} height={60} width={60} />
    </div>
